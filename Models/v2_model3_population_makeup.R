...
plot(simulationOutput_m3_since) #are the residuals concerning?
...
plot(simulationOutput_m3_effort) #are the residuals concerning?
...
plot(simulationOutput_m3_year) #are the residuals concerning?
